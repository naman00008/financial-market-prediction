...
# Safe optional monkeypatch for Tornado REST handlers
try:
    import tornado.web
    import streamlit.web.server.server as st_server

    if hasattr(st_server, "Server") and hasattr(st_server.Server, "_create_app"):
    ...
    # Safe fallback if Streamlit internal architecture varies
    pass
